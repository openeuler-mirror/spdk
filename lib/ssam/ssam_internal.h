...
#define VIRITO_FS_DEFAULT_QUEUE_SIZE     1024
#define VIRTIO_FS_DEFAULT_CONFIG_LEN     44
#define VIRTIO_FS_DEFAULT_TAG_LEN        36
#define VIRTIO_FS_DEFAULT_CONFIG_QUEUE_OFFSET   9
...
#define SPDK_INVALID_MAX_THREADS         UINT16_MAX
 ...
 */
int ssam_session_unregister(struct spdk_ssam_session *smsession);
